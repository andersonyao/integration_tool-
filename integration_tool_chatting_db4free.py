...
class Ui_PublicChattingPlatform(QtGui.QFrame):
    def __init__(self,parent=None):
        ...
        self.photo.setToolTip(u'可以编辑发布人头像！')
        QtCore.QObject.connect(self.photo, QtCore.SIGNAL("clicked(PyQt_PyObject)"), self.Upload_photo)
        author = QtGui.QLabel(u'发布者',self.chat_frame_2)
        title = QtGui.QLabel(u'发布时间',self.chat_frame_2)
        review = QtGui.QLabel(u'消息内容',self.chat_frame_2)
        review.setToolTip(u'可以编辑此次发布内容！')
        ...
        self.authorEdit.setToolTip(u'可以编辑发布人名！')
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab),  "chatting history")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), "chatting publish")
        ...
        try:
            ...
            try:
                try:
                    ...
                    QtGui.QMessageBox.information(self, u'提交提示', e,QtGui.QMessageBox.Ok)
                    print 'User_Photos Select failed:',e
                curw0.execute("update User_Photos set PhotoPath= %s where English_Name=%s", (self.tempr1,self.authorEdit.text()))
            except Exception,e:
                QtGui.QMessageBox.information(self, u'提交提示', e,QtGui.QMessageBox.Ok)
                print 'User_Photos update failed:',e
            ...
            QtGui.QMessageBox.information(self, u'提交提示', e,QtGui.QMessageBox.Ok)
            print 'User_Messages connect failed:',e
            pass
